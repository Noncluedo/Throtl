...
async def main():
    ...
    music_playOnce = True
    jump_sfx = [0,0,0,0] 
    jump_sfx[0] = pygame.mixer.Sound("Audio/Jump.wav")
    jump_sfx[1] = pygame.mixer.Sound("Audio/Jump2.wav")
    jump_sfx[2] = pygame.mixer.Sound("Audio/Jump3.wav")
    jump_sfx[3] = pygame.mixer.Sound("Audio/Jump4.wav")
    boom_sfx = pygame.mixer.Sound("Audio/boom.wav")
    boom_sfx_playOnce = True
    score_sfx = pygame.mixer.Sound("Audio/Score.wav")
    score_sfx.set_volume(0.2)
    score5_sfx = pygame.mixer.Sound("Audio/Score5.wav")
    score5_sfx.set_volume(0.2)
    score10_sfx = pygame.mixer.Sound("Audio/Score10.wav")
